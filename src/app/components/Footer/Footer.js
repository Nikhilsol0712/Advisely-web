          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            <div className="col-span-2">
              <div>
                <h2 className="text-2xl font-bold text-gray-900">
                  From Mindblowing Technologies
                </h2>

                <p className="mt-4 text-gray-500">
                  The largest Personalised Student Counselling Study Abroad
                  Platform in the world. Obsessed with Student Success.
                </p>
              </div>
            </div>
            ...
            <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
              <form className="w-full">
                ...
                <div className="border border-gray-100 p-2 rounded-lg sm:flex sm:items-center sm:gap-4">
                  <input
                    type="email"
                    id="UserEmail"
